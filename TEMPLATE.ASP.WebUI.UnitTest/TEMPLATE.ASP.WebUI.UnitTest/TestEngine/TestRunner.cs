	...
	namespace TEMPLATE.UnitTest
	{
		...
		{
			private  String BASE_URL = ConfigurationManager.AppSettings["UnitTestAsp.UrlWebProject"] + @"/TEMPLATE.ASP.WebUI.UnitTest/TestEngine/TestASPUnitJSON.asp?UnitRunner=results";
